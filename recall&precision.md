...
ここに、絶対に避けては通れない数学的な宿命（トレードオフ）が存在する。

もし、上司や世論から「1人も凶悪犯を逃がすな！（Recall 100%を目指せ）」と命令されたら、警察はどうするだろうか。彼らは捕まえるハードル（閾値）を極限まで下げるしかない。「少しでも怪しい動きをした者」を片っ端から全員逮捕するのだ。

その結果、100人の凶悪犯は全員捕まえられる（Recall 100%）。しかし、その引き換えとして、**何千人もの「全く無実の一般市民（False Positive：偽陽性）」まで一緒に網に巻き込まれ、誤認逮捕されてしまう**ことになる。

こうなると、警察が「お前が犯人だ」と捕まえた分母が巨大化しすぎるため、その中に含まれる本物の犯人の割合、つまり**「Precision（正確さ）」はゼロに向かって限りなく暴落する。**

「1つも見落とさないこと（Recall）」を狂信的に追い求めると、システムは構造上、「正しい判断（Precision）」をあらかじめ放棄せざるを得なくなる。これは人間の精神論や努力で克服できる問題ではなく、この世界に横たわる絶対的な数理の罠なのである。
