...
### 4. 【現実の罠】実験室の「95%」が、現実の「16%」へ大暴落する構造

ここまで前章の数理モデルを見て、「よし、では数式に基づいて閾値を設計すれば現実をコントロールできる」と思われたかもしれない。しかし、ここにリアルな現実社会が牙を剥く、もう一つの最悪な数理の罠が潜んでいる。

私たちがニュースや仕様書で目にする「このシステムの精度（適合率：Precision）は95%です」という輝かしい数値。実はそのほとんどが、現実世界では全く役に立たない**「実験室の中の幻影」**に過ぎない。

なぜなら、開発者がシステムやAIをテスト（バリデーション）する際、彼らは「100人のターゲット」と「100人の一般人」を集めた、**「50：50」に綺麗に整えられた実験室の世界**を用意するからだ。偏りのない均等な世界であれば、システムは確かに95%の確率で正解を叩き出せる。

しかし、ひとたびそのシステムを、私たちが生きる「リアルな現実世界」に解き放った瞬間、大惨劇が起きる。現実の社会は、ターゲット（凶悪犯、違反投稿、あるいは稀少な病）が全体のごくわずか、たとえば「1万人のうち100人（1%）」しか存在しないような、**オッズが極端に偏った世界**だからである。

数学的な結論から言おう。現実世界における「実際のPrecision」は、実験室の数値から、**この母集団の『1:99（1%）』という偏ったオッズの掛け算によって、文字通り何桁も暴落する。**

具体的な数字でそのメカニズムを完全に解剖してみよう。
